...
<template>
    <div class="container">
        <form class="form-style w-[200px] mt-[50px]">
            ...
            <button @click="bmical" id="my_btn" class="my_btn mt-[10px] border border-black	" type="button">開始計算</button>
            <button @click="clearbmi" id="my_btn" class="my_btn mt-[10px] border border-black ml-px" type="button">清除計算</button>
